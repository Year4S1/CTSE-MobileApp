import { NativeBaseProvider, ScrollView,NativeBaseButton } from "native-base";
import React, { cloneElement, useEffect, useState } from "react";
import { Button, ImageBackground, Linking, Pressable, StyleSheet, View } from "react-native";
      ...
      <ImageBackground source={image} resizeMode="cover" style={{ flex: 1 }}>
        <ScrollView>
          ...
          <Button
            ...
            onPress={() => Linking.openURL('mailto:anjana.dinethra@gmail.com?subject=Workout Plan&body=Workout plan added success')}
            title="Get Workout plan via Email"
          >
          </Button>
          </View>
        </ScrollView>
